...
inputFiles = [ "axion1_60-500GeV_20k.root", "axion2_60-500GeV_20k.root", "scalar1_60-500GeV_20k.root", "gamma_60-500GeV_20k.root", "pi0_60-500GeV_20k.root", "electron_60-500GeV_20k.root" ]
...
for iFile in range(len(inputFiles)):
	...
	#Loop over all events
	    ...
	    for j in range(964):
	        ...
	        if (xbin < 0 or ybin < 0):
	            ...
	            pass
	        if (zbin==0):
                    print("found Zbin=0, energy = ", energy)
	...
	c1.Divide(2,2)
	c1.cd(1);
        print("zsegmentation bin", zsegmentation.GetBinContent(1), zsegmentation.GetBinContent(2))
	zsegmentation.Draw()
	c1.cd(2);
